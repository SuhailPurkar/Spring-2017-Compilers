...
class JavaCCParser implements JavaCCParserConstants {
  ...
  final private JAST typeDeclaration() throws ParseException {
    ...
    try {
      ...
      case STATIC:
        mods = modifiers();
        typeDecl = classDeclaration(mods);
        break;
      case INTERFACE:
        typeDecl = interfaceDeclaration(mods);
        break;
      default:
        jj_la1[4] = jj_gen;
        jj_consume_token(-1);
  ...
  final private JStatement statement() throws ParseException {
    ...
    //HW4 For statement added
    JExpression array = null;
    JBlock bodyblock = null;
    JVariableDeclarator initialize = null;
    JExpression update = null;
    JStatement terminate = null;
    JVariableDeclarator init = null;
    JExpression term = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LCURLY:
        statement = block();
      ...
      case FOR:
        ...
        initialize = variableDeclarator(type());
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COLON:
        case SEMI:
        ...
        bodyblock = block();
                 if (terminate == null)
                 {statement
                        = new JEnhancedForStatement(line, initialize, array,
                                                        bodyblock);}

                 else {
                         statement
                        = new JForStatement(line, initialize, term, update,
                                                bodyblock);}
        break;
      case RETURN:
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x100000,0x8000,0x2e00480,0x0,0x2e00480,0x2e00080,0x2e00080,0x1000,0x1000,0x1000,0x1000,0xa2e20380,0xa2e20380,0xa0020300,0x0,0x80020300,0xdd0e6300,0x5d0c6000,0x0,0x0,0x1c0c2000,0x5d0c6000,0x0,0x80020300,0x0,0x0,0x1c0c2000,0x0,0x1c0c2000,0x0,0x1c0c2000,0x80020300,0x80020300,0x0,0x0,0x80020300,0x0,0x0,0x0,0x0,0x10000,0x10000,0x0,0x0,0x0,0x1c0c2000,0x0,0x1c0c2000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1c0c2000,0x80020300,0x0,0x0,0x0,0x10082000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x10,0x4000000,0x10,0x0,0x0,0x8,0x8,0x8,0x8,0x8000003,0x8000003,0x8000003,0x1100000,0x8000003,0x9146407,0x9146404,0x1000000,0x1020000,0x8046400,0x9146404,0x2000000,0x8000003,0x2000000,0x40,0x8146400,0x2000000,0x8146400,0x2000000,0x8046400,0x3,0x3,0x400000,0x400000,0x8000003,0x8040,0x8040,0x800,0x100,0x1200,0x1200,0x4020,0x4020,0x10000,0x8046400,0x2000,0x8040000,0x4400000,0x80,0x40000,0x4400000,0x40000,0x40000,0x4040000,0x40000,0x8040000,0x8000003,0x100000,0x40000,0x400000,0x0,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1dc,0x1dc,0x0,0x0,0x1dc,0x1dc,0x0,0x0,0x0,0x0,0x1dc,0x0,0x1dc,0x0,0x1dc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1dc,0x0,0x1dc,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1dc,0x0,0x0,0x0,0x0,0x1dc,};
   }
