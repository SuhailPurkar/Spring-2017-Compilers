...
class JDivideOp extends JBinaryExpression {
	...
	public JExpression analyze(Context context){
		...
		rhs.type().mustMatchExpected(line(), Type.INT);
		type = Type.INT;
		return this;//analyze implemented for JDivideOp
	}
	public void codegen(CLEmitter output){
		//implemented IDIV instruction
		lhs.codegen(output);
		rhs.codegen(output);
...
class JModuloOp extends JBinaryExpression {
	...
	public JExpression analyze(Context context){
		...
		rhs.type().mustMatchExpected(line(), Type.INT);
		type = Type.INT;
		return this;//analyze implemented for JModuloOp
	}
	public void codegen(CLEmitter output){
		//implemented IREM instruction
		lhs.codegen(output);
		rhs.codegen(output);
...
class JAndOp extends JBinaryExpression {
	...
	public JExpression analyze(Context context){
		...
		rhs.type().mustMatchExpected(line(), Type.INT);
		type = Type.INT;
		return this;//analyze implemented for JAndOp
	}
	public void codegen(CLEmitter output){
		//implemented IREM instruction
		lhs.codegen(output);
...
class JXorOp extends JBinaryExpression {
	...
	public JExpression analyze(Context context){
		...
		rhs.type().mustMatchExpected(line(), Type.INT);
		type = Type.INT;
		return this;//analyze implemented for JXorOp
	}
	public void codegen(CLEmitter output){
		//implemented IXOR instruction
		lhs.codegen(output);
		rhs.codegen(output);
...
class JOrOp extends JBinaryExpression {
	...
	public JExpression analyze(Context context){
		...
		rhs.type().mustMatchExpected(line(), Type.INT);
		type = Type.INT;
		return this;//analyze implemented for JOrOp
	}
	public void codegen(CLEmitter output){
		//implemented IOR instruction
		lhs.codegen(output);
		rhs.codegen(output);
