...
//HW3
//CS451
//Editted to allow implementing interfaces
package jminusminus;
...
class JClassDeclaration extends JAST implements JTypeDecl {
	...
	//Interfaces
	private ArrayList<TypeName> interfaces_implemented;
    ...
    public JClassDeclaration(int line, ArrayList<String> mods, String name,
            Type superType, ArrayList<TypeName> interfaces_implemented, 
		...
		this.interfaces_implemented = interfaces_implemented;
    }
     ...
     */
	 ...
	 //modified HW3, know should handle implements
    public void writeToStdOut(PrettyPrinter p) {
		...
		for(int i = 0; i < interfaces_implemented.size(); i++){
			p.printf("<Implents name=\"" +
			interfaces_implemented.get(i).toString() + "\"/>\n");
		}
        p.indentLeft();
        p.printf("<Implements>\n");
