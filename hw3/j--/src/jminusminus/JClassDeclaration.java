...
class JClassDeclaration extends JAST implements JTypeDecl, JMember {
    ...
    //hw3 added 
    private ArrayList<TypeName> interfaces;
    /**
     ...
     */
    	...
    	public JClassDeclaration(int line, ArrayList<String> mods,
    			String name, Type superType, ArrayList<TypeName> interfaces,
    ...
    public void writeToStdOut(PrettyPrinter p) {
      ...
      //hw3 added
    	p.printf("<Interfaces>\n");
        for (TypeName implementing : interfaces) {
        	p.indentRight();
